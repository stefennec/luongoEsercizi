  ...
  <html lang="en" dir="ltr">
    ...
    Nome
    Cognome
    accetta contratto con un check
    bottone submit

    con rispettive label
  -->
  ...
  <div class="container">
    <form class="form-group" name="esercizio_Email" id="esercizio_Email" action="esercizio_Email.php" method="post">
      <h3>Email:</h3>
